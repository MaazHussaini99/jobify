...
export default function NotificationCreateForm(props) {
  ...
  const resetStateValues = () => {
    ...
    setRelatedJobId(initialValues.relatedJobId);
    setRelatedUserId(initialValues.relatedUserId);
    setRelatedApplicationId(initialValues.relatedApplicationId);
    setRelatedMessageId(initialValues.relatedMessageId);
