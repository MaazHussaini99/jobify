...
`;
export const meetingsByOrganizerId = /* GraphQL */ `
  query MeetingsByOrganizerId(
    $organizerId: ID!
    $sortDirection: ModelSortDirection
    $filter: ModelMeetingFilterInput
    $limit: Int
...
`;
export const meetingsByProfessionalId = /* GraphQL */ `
  query MeetingsByProfessionalId(
    $professionalId: ID!
    $sortDirection: ModelSortDirection
    $filter: ModelMeetingFilterInput
    $limit: Int
...
`;
export const meetingsByJobId = /* GraphQL */ `
  query MeetingsByJobId(
    $jobId: ID!
    $sortDirection: ModelSortDirection
    $filter: ModelMeetingFilterInput
    $limit: Int
